...
public class ChanceTest {
    ...
    @Test
    public void chance_can_not_be_created_with_a_value_less_than_zero() throws InvalidChanceInput {
    ...
    @Test
    public void chance_can_not_be_created_with_a_value_greater_than_one() throws InvalidChanceInput {
        thrown.expect(InvalidChanceInput.class);
    ...
    @Test
    public void chance_can_be_negated() throws InvalidChanceInput {
    ...
    @Test
    public void two_chances_can_be_anded() throws InvalidChanceInput {
    ...
    @Test
    public void two_chances_can_be_ored() throws InvalidChanceInput {
        Chance chance = Chance.create(0.75);
        Chance otherChance = Chance.create(0.25);
